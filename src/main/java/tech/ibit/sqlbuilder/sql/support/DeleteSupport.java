...
public interface DeleteSupport<T> extends SqlSupport<T>, PrepareStatementSupport {
     ...
     * @return 预查询SQL对象
     */
    default PrepareStatement getDeleteItemPrepareStatement(boolean useAlias) {
        ...
        return getPrepareStatement("DELETE ", deleteTables
                , (Table table) -> table.getSelectTableName(useAlias) + ".*", null, ", ");
    }
